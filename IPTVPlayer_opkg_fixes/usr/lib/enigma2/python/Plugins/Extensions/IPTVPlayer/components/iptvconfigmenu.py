...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import printDBG, printExc, GetSkinsList, GetHostsList, IsHostEnabled, GetPluginDir
...
class ConfigMenu(ConfigBaseWidget):
    ...
    def fillConfigList(list, hiddenOptions=False):
        ...
        if config.plugins.iptvplayer.GOScontrol.value == False:
