...
config.autoshutdown.inactivetime = ConfigInteger(default = 180, limits = (1, 1440))
...
config.autoshutdown.inactivitymessage = ConfigYesNo(default = False)
